package com.banco.carrefour.ui.details
...
import com.banco.carrefour.databinding.FragmentDetailsBinding
import com.banco.carrefour.extension.formatDate
...
class DetailsFragment : Fragment(R.layout.fragment_details) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            createDate.text = args.repo.createDate.formatDate()
            updateDate.text = args.repo.updateDate.formatDate()
