package com.banco.carrefour.ui.list.adapter
...
import com.banco.carrefour.databinding.ItemTrendingRepoBinding
import com.banco.carrefour.ui.list.ListFragmentDirections
import com.bumptech.glide.Glide

class GithubAdapter: PagingDataAdapter<Repo, GithubAdapter.ViewHolder>(REPO_COMPARATOR) {
    ...
    private fun createOnClickListener(binding : ItemTrendingRepoBinding, repo: Repo): View.OnClickListener {
        return View.OnClickListener {
            val directions = ListFragmentDirections.actionReposToDetails(repo)
